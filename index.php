                ...
                <div class="w_860">
                    <div class="f_l">
                        <figure class="hidd_text">
                            <img src="./images/main/logo_title.png" alt="logo_title.jpg">
                            Строительный магазин "кирпич"
                        </figure>
                    </div>
                    <div class="f_r currency"></div>
                    <ul class="f-s_0 phones">
                        <li>
                            <div><sup>+38 (066)</sup><span class="d_n">−</span> <span>666-66-66</span></div>
                            <div><sup>+38 (055)</sup><span class="d_n">−</span> <span>55-55-555</span></div>
                        </li>
                        <li>
                            <div><span>0-<span class="d_n">-</span>800-999-999</span> — бесплатно<br>со стационарных телефонов Украины</div>
